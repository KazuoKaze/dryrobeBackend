...
from .models import JustSending, OrderItem, Coupon, SizeVariant, OrderItemProduct, ColorVariant, ColorClassVariant
...
class SizeVariantSerizlier(ModelSerializer):
    class Meta:
        model = SizeVariant
        fields = '__all__'

class ColorClassVariantSerializer(ModelSerializer):
    class Meta:
        model = ColorClassVariant
        fields = ['varianImg1', 'varianImg2', 'varianImg3', 'varianImg4', 'varianImg5', 'varianImg6', 'varianImg7', 'varianImg8', 'varianImg9']

class ColorVariantSerizlier(ModelSerializer):
    imgsHere = ColorClassVariantSerializer(many=False)
    class Meta:
        model = ColorVariant
        fields = '__all__'
